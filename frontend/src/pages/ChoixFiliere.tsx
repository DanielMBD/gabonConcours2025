        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Sélectionnez la filière pour le concours : <span className="font-semibold">{concours.libcnc}</span>
            </p>
              ...
              {filieres.length > 0 ? (
                ...
                >
                  {filieres.map((filiere: ConcoursFiliere) => (
                    <div key={filiere.id} className="flex items-center space-x-3 p-4 border rounded-lg hover:bg-muted/50">
                      <RadioGroupItem value={filiere.filiere_id.toString()} id={`filiere-${filiere.id}`} />
                      <Label 
