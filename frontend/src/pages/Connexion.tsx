            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="hidden lg:block">
                <div className="relative">
                  ...
                  {/* Éléments décoratifs */}
                  <div className="absolute top-1/4 right-0 w-20 h-20 bg-primary/10 rounded-full blur-xl"></div>
                  <div className="absolute bottom-1/4 left-0 w-32 h-32 bg-blue-500/10 rounded-full blur-xl"></div>
                </div>
              </div>
            </div>
          </div>
