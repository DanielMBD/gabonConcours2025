...
import { CheckCircle, Download, Mail, Home, FileText, User, Calendar, Phone, MapPin, GraduationCap, Gift, AlertTriangle } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div>
                  <label className="text-sm font-medium text-muted-foreground">Numéro de candidature</label>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="text-sm font-medium text-muted-foreground">Intitulé du concours</label>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>• Conservez précieusement votre numéro de candidature: <strong>{candidatData?.nupcan || decodedNupcan}</strong></p>
