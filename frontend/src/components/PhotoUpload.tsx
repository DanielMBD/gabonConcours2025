        ...
        {preview ? (
          ...
          <div className="relative">
            <input
              ...
              required={required}
            />
            <div className="w-32 h-32 border-2 border-dashed border-primary/30 rounded-lg flex flex-col items-center justify-center bg-primary/5 hover:bg-primary/10 transition-colors cursor-pointer">
