            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="space-y-6 text-center">
                ...
                <div className="flex justify-center">
                  <div className="w-32 h-32 rounded-lg overflow-hidden border-4 border-primary/20 shadow-lg bg-white">
                    {candidat?.phtcan ? (
                      <img
                ...
                <div className="space-y-2">
                  <div className="flex justify-center">
                    {qrCodeUrl ? (
                      <img src={qrCodeUrl} alt="QR Code Candidature" className="border rounded-lg" />
                    ) : (
