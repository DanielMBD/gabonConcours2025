...
const PaymentMethodLogo: React.FC<PaymentMethodLogoProps> = ({ 
  ...
  if (method === 'airtel') {
    return (
      <div className={`${sizeClasses[size]} ${className} flex items-center justify-center bg-red-600 rounded-lg shadow-md`}>
  ...
  if (method === 'moov') {
    return (
      <div className={`${sizeClasses[size]} ${className} flex items-center justify-center bg-blue-600 rounded-lg shadow-md`}>
        <svg viewBox="0 0 100 100" className="w-full h-full p-1">
          <defs>
  ...
  if (method === 'virement') {
    return (
      <div className={`${sizeClasses[size]} ${className} flex items-center justify-center bg-green-600 rounded-lg shadow-md`}>
