...
const IllustrationGraduate: React.FC<{ className?: string }> = ({ className = "w-full h-auto" }) => {
  return (
    ...
    >
      ...
      <path d="M75 100 L79 104 L85 96" stroke="#10B981" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      
      <circle cx="330" cy="150" r="15" fill="#3B82F6" opacity="0.2" />
      <path d="M325 150 L330 145 L335 155" stroke="#3B82F6" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
