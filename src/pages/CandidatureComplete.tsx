              ...
              <Card>
                ...
                <CardContent className="text-center">
                  ...
                  <Label htmlFor="photo" className="cursor-pointer">
                    <div className="flex items-center justify-center space-x-2 bg-primary/10 hover:bg-primary/20 transition-colors p-3 rounded-lg">
            ...
            <div className="lg:col-span-2">
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, nomcan: e.target.value.toUpperCase() }))}
                    ...
                    <div>
                      <Label htmlFor="prncan">Prénom <span className="text-red-500">*</span></Label>
                      <Input
                        id="prncan"
                        value={formData.prncan}
                        onChange={(e) => setFormData(prev => ({ ...prev, prncan: e.target.value }))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="maican">Email <span className="text-red-500">*</span></Label>
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={(e) => setFormData(prev => ({ ...prev, maican: e.target.value }))}
                    ...
                    <div>
                      <Label htmlFor="telcan">Téléphone <span className="text-red-500">*</span></Label>
                      <div className="relative">
                        <Phone className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                        <Input
                          id="telcan"
                          value={formData.telcan}
                          onChange={(e) => setFormData(prev => ({ ...prev, telcan: e.target.value }))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="dtncan">Date de naissance <span className="text-red-500">*</span></Label>
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={(e) => setFormData(prev => ({ ...prev, dtncan: e.target.value }))}
                          className="pl-10"
                          required
                        />
                      </div>
                    ...
                    <div>
                      <Label htmlFor="ldncan">Lieu de naissance <span className="text-red-500">*</span></Label>
                      <div className="relative">
                        <MapPin className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                        <Input
                          id="ldncan"
                          value={formData.ldncan}
                          onChange={(e) => setFormData(prev => ({ ...prev, ldncan: e.target.value }))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="niveau_id">Niveau d'études <span className="text-red-500">*</span></Label>
                      <Select value={formData.niveau_id.toString()} onValueChange={(value) => setFormData(prev => ({ ...prev, niveau_id: parseInt(value) }))}>
                        <SelectTrigger>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setFormData(prev => ({ ...prev, nipcan: e.target.value }))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <Label htmlFor="proorg">Province d'origine <span className="text-red-500">*</span></Label>
                      <Select value={formData.proorg.toString()} onValueChange={(value) => setFormData(prev => ({ ...prev, proorg: parseInt(value) }))}>
                        <SelectTrigger>
                    ...
                    <div>
                      <Label htmlFor="proact">Province actuelle <span className="text-red-500">*</span></Label>
                      <Select value={formData.proact.toString()} onValueChange={(value) => setFormData(prev => ({ ...prev, proact: parseInt(value) }))}>
                        <SelectTrigger>
                    ...
                    <div>
                      <Label htmlFor="proaff">Province d'affectation <span className="text-red-500">*</span></Label>
                      <Select value={formData.proaff.toString()} onValueChange={(value) => setFormData(prev => ({ ...prev, proaff: parseInt(value) }))}>
                        <SelectTrigger>
