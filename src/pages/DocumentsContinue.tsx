      ...
      <Layout>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <p className="text-blue-600 mb-4">
                  Vous avez déjà soumis {existingDocuments.data.length} document(s) pour cette candidature.
                </p>
          ...
          <div className="flex justify-between">
            <Button variant="outline" onClick={() => navigate(`/dashboard/${encodeURIComponent(decodedNupcan)}`)} className="flex items-center space-x-2">
