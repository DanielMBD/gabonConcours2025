...
router.post('/receipt', async (req, res) => {
  try {
    const { email, nupcan, candidatData, pdfAttachment } = req.body;
    
    console.log('Envoi reçu par email pour:', email, nupcan);
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8fafc; padding: 30px; border: 1px solid #e2e8f0;">
            ...
            <p>Vous trouverez en pièce jointe votre reçu officiel de candidature au format PDF.</p>
...
router.post('/document-validation', async (req, res) => {
  try {
    ...
    console.log('Envoi notification validation document à:', candidat.email);
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8fafc; padding: 30px; border: 1px solid #e2e8f0;">
            ...
            <div style="background: white; padding: 20px; border-left: 4px solid ${isValidated ? '#10b981' : '#ef4444'}; margin: 20px 0; border-radius: 0 8px 8px 0;">
              ...
              <p style="margin: 5px 0;"><strong>📋 Nom du fichier:</strong> ${document.nom}</p>
    ...
    console.log('Notification envoyée avec succès à:', candidat.email);
